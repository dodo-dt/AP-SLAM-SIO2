...
?>
  ...
  <section class="hero">
    ...
    <!-- Éléments décoratifs africains - 7 feuilles -->
    ...
    <!-- Carrousel d'images avec image rotative en arrière-plan -->
    <div class="hero-visual">
      <div class="rotating-circle">
        <div class="rotating-circle__inner" aria-hidden="true"></div>
      </div>
  ...
  <div class="section-separator">
    <svg viewBox="0 0 1200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M0,0 C150,80 350,80 600,40 C850,0 1050,0 1200,40 L1200,120 L0,120 Z" fill="#1a1a1a"/>
    </svg>
  </div>
